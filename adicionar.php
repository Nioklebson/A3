   ...
   if (($dadocpf == NULL ) && 
    ($dadologin == NULL)){
        ...
        $queryusuario = 
            ...
            $insertlogin = "INSERT INTO
             login (cpf , login , senha, nivel)
            VALUES
            ('$cpf', '$login', '$senhacriptografada',3)";
            $querylogin = mysqli_query($conexao,$insertlogin);
            echo '<script>alert("Usuário cadastrados com sucesso");
        ...
        ou login já cadastrados no sistema");
			window.location="adicionar.php";
			</script>';
         }
    }
...
<body>
    <center>
        ...
        <form id="form-add"
        action="#" method="POST">
        Nome: <input type text="text" name="nome"><br>
